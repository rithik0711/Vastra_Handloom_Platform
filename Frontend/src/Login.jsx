...
export default function Login() {
  ...
  const handleSubmit = (e) => {
    ...
    const userRole = getUserRole(email.trim().toLowerCase());

    if (!userRole) {
      alert("This email is not registered in Vastra.");
      return;
    }
  ...
  const handleGoogleSuccess = (credentialResponse) => {
    try {
      ...
      if (!googleEmail) {
        alert("Unable to get your Google account email.");
        return;
      }

      // Find role
      const userRole = getUserRole(googleEmail);

      // Check registered user
      if (!userRole) {
        alert("This Google account is not registered in Vastra.");
        return;
      }
    ...
    <div className="fixed inset-0 w-screen h-screen overflow-hidden bg-[#f7f3eb]">
      ...
      <div className="absolute left-1/2 right-auto top-1/2 -translate-x-1/2 -translate-y-1/2 w-[calc(100%-24px)] max-w-[390px] h-[calc(100vh-16px)] max-h-[720px] bg-[#fcfbf7]/[0.98] border border-white/70 rounded-[18px] shadow-[0_15px_45px_rgba(35,25,15,0.20)] flex flex-col items-center overflow-hidden md:left-auto md:right-[8%] md:translate-x-0 md:w-[480px] md:max-w-none md:h-[calc(100vh-24px)] md:max-h-none md:rounded-[16px] lg:w-[520px]">
        ...
        <form
          ...
          className="w-[86%] max-w-[330px] flex flex-col sm:max-w-[340px] md:w-[80%] md:max-w-[360px] lg:max-w-[380px]"
        >
          ...
          <div className="w-full mb-[11px] sm:mb-[13px] md:mb-[15px]">
            ...
            <label
              htmlFor="email"
              className="block text-[14px] sm:text-[15px] md:text-[16px] font-medium text-[#292421] mb-[5px]"
            >
              Email
            </label>
            ...
            <div className="relative w-full">
              ...
              <span className="absolute left-[11px] sm:left-[12px] md:left-[13px] top-1/2 -translate-y-1/2 text-[#817b74] pointer-events-none z-10">
                <svg
                  ...
                  strokeWidth="1.5"
                  stroke="currentColor"
                  className="w-[18px] h-[18px] md:w-[19px] md:h-[19px]"
                >
                  <path
                    strokeLinecap="round"
              ...
              <input
                ...
                required
                className="box-border w-full h-[42px] sm:h-[44px] md:h-[46px] pl-[38px] sm:pl-[40px] md:pl-[42px] pr-[10px] bg-white border border-[#c7c0b6] rounded-[9px] md:rounded-[10px] text-[13px] md:text-[14px] text-[#302b27] placeholder-[#a29b93] outline-none transition focus:border-[#8b5b24] focus:ring-2 focus:ring-[#c08a35]/20"
              />
          ...
          <div className="w-full">
            ...
            <div className="relative w-full">
              ...
              <input
                ...
                required
                className="box-border w-full h-[42px] sm:h-[44px] md:h-[46px] pl-[38px] sm:pl-[40px] md:pl-[42px] pr-[42px] bg-white border border-[#c7c0b6] rounded-[9px] md:rounded-[10px] text-[13px] md:text-[14px] text-[#302b27] placeholder-[#a29b93] outline-none transition focus:border-[#8b5b24] focus:ring-2 focus:ring-[#c08a35]/20"
              />
              ...
              <button
                ...
                className="absolute right-[10px] md:right-[12px] top-1/2 -translate-y-1/2 text-[#77716b] hover:text-[#4a1525] transition"
              >
                {showPassword ? (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="M2.036 12c1.274 4.057 5.064 7 9.542 7 4.477 0 8.268-2.943 9.542-7-1.274-4.057-5.064-7-9.542-7-4.477 0-8.268 2.943-9.542 7z"
                    />
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
            ...
            <div className="flex justify-end mt-[5px]">
              <a
                ...
                className="text-[11px] sm:text-[12px] md:text-[13px] text-[#6d665f] underline hover:text-[#4a1525] transition"
              >
                Forgot password?
              </a>
            </div>
        ...
        <div className="w-[86%] max-w-[330px] sm:max-w-[340px] md:w-[80%] md:max-w-[360px] lg:max-w-[380px] flex items-center gap-[8px] my-[11px] sm:my-[13px] md:my-[15px]">
          ...
          <span className="text-[10px] md:text-[11px] text-[#8a837b]">
            OR
          </span>
          <div className="flex-1 h-px bg-[#d8d1c8]" />
        </div>
